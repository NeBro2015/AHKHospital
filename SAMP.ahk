...
; ############################################################################################################################################ ;
; #                                                                                                                                          # ;
; #     - getWeaponAmmo()                          -    1) Ammo - возвращает в переменную общее количество патрон. 2) Clip - возвращает в переменную количество патрон в магазине
...
Gui, Add, Text, x12 y19 w90 h20 , Ник
Gui, Add, Text, x12 y49 w90 h20 , Пол
Gui, Add, Text, x12 y79 w90 h20 , Номер телефона
Gui, Add, Edit, x112 y19 w380 h20 , Ник
Gui, Add, Edit, x112 y79 w110 h20 , Edit
Gui, Add, DropDownList, x112 y49 w110 h20 , Мужской|Женский
Gui, Add, Text, x232 y49 w90 h20 , Организация
Gui, Add, Text, x232 y79 w90 h20 , Должность
Gui, Add, DropDownList, x332 y49 w160 h20 , Больница г.Лос-Сантос|Больница г.Сан-Фиерро|Больница г.Лас-Вентурас
Gui, Add, DropDownList, x332 y79 w160 h21 , Интерн
Gui, Add, Text, x12 y109 w90 h20 , РП Часы
Gui, Add, Edit, x112 y109 w380 h20 , Часы
Gui, Add, Button, x181 y169 w140 h30 , Сохранить
Gui, Add, Text, x12 y139 w90 h20 , Строчка о ЗП
Gui, Add, Edit, x112 y139 w380 h20 , ЗП
Gui, Add, Button, x12 y209 w480 h20 , ???
Gui, Show, w507 h463, Untitled GUI
return
